...
public class CustomBear extends EntityPolarBear{

	public CustomBear(Location loc) {
	...
	public void initPathfinder() {
		...
		this.targetSelector.a(3, new PathfinderGoalAvoidTarget<EntityBlaze>(this, EntityBlaze.class, 5, 1.0D, 1.0D));
	}
}
