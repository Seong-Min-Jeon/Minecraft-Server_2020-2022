...
public class ChestOwner {
	...
	public ChestOwner(Player player, int num, Inventory inv) {
		...
		} else if(player.getUniqueId().toString().equals("25140af5-c72c-42db-a998-379cdef4ae91")) {
			tapejara(player, num, inv);
	...
	public void yumehama(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3774, 7, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3774, 9, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3774, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3774, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3774, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void espina_id(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3784, 9, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3784, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3784, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void tapejara(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 17, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 19, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 21, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 23, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 25, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 27, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3782, 29, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void why9196(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3780, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3780, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3780, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3780, 17, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void akilae3102(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3778, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3778, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3778, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void woolring(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 9, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 17, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 19, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
			...
			Location chestLoc = new Location(player.getWorld(), 3776, 21, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			}
	...
	public void sarashina_ruka(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 7, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 9, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 17, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 19, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 21, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 23, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 25, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3772, 27, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3768, 5, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
	...
	public void junletTridner(Player player, int num, Inventory inv) {
		if(num == 2) {
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 7, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 9, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 11, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 13, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 15, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 17, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 19, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
			...
			Location chestLoc = new Location(player.getWorld(), 3770, 21, 3745);
			if(inv == null) {
				openInv(player, chestLoc.getBlock());
				return;
			} else 
