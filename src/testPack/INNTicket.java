...
public class INNTicket {
	...
	public void sleep(Player player, ItemStack itemArg) {
	...
	public void wargunil(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "워그닐 숙박 티켓")) {
	...
	public void forgan(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "포르간 숙박 티켓")) {
	...
	public void tiru(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "티르 숙박 티켓")) {
	...
	public void kaiman(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "카이만 숙박 티켓")) {
	...
	public void osu(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "오스 숙박 티켓")) {
	...
	public void konno(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "콘노 숙박 티켓")) {
	...
	public void fuhidmeh(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "프휘 드 메흐 숙박 티켓")) {
	...
	public void sitasaidi(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "시타사이디 숙박 티켓")) {
	...
	public void karce(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "칼스 숙박 티켓")) {
	...
	public void kuredrat(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "크레드라트 숙박 티켓")) {
	...
	public void beiag(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "베아그 숙박 티켓")) {
	...
	public void longue(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "롱게 숙박 티켓")) {
	...
	public void hamabe(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "하마베 숙박 티켓")) {
	...
	public void kekktas(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "캑터스 숙박 티켓")) {
			//캑터스 -750 50 -885  -769 82 -907
	...
	public void furelioud(Player player, ItemStack itemArg, World world) {	
		if(itemArg.getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "프렐리우드 숙박 티켓")) {
