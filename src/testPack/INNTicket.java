...
public class INNTicket {
	...
	public void kekktas(Player player, Item itemArg, World world) {	
		if(itemArg.getItemStack().getItemMeta().getDisplayName().equalsIgnoreCase(ChatColor.WHITE + "캑터스 숙박 티켓")) {
